      ...
      <div className="container mx-auto relative z-10">
        <div className="flex flex-col-reverse lg:flex-row items-center lg:gap-20">
          ...
          <motion.div
            ...
            className="flex-none bg-about bg-contain bg-no-repeat h-64 lg:h-96 lg:w-1/3"
          >
            <img
              loading="lazy"
          ...
          <motion.div
            ...
            whileInView={"show"}
            viewport={{ once: false, amount: 0.3 }}
            className="flex-1 p-6 uppercase lg:w-2/3"
          >
            <h2 className="text-3xl lg:text-4xl font-bold text-purple-400">
              Experienced Full-Stack Developer
            </h2>
            <h2 className="text-xl lg:text-2xl font-bold text-cyan-300 mt-4">
              Crafting <span className="text-white">Pixel-Perfect</span>{" "}
              Websites for Over 4 Years
            </h2>

            <p className="mt-4 text-lg text-cyan-100 glow break-words">
            ...
            <div className="text-green-400 text-xl uppercase mt-4">
              What sets me apart?
            </div>
            <p className="mt-4 text-cyan-100 glow break-words">
